...
export const SYLLABUS: SyllabusStrand[] = [
  { line: "中1 数学", topics: ["正負の数の計算", "文字式の計算", "分配法則", "一次方程式", "比例と反比例", "平面図形", "空間図形", "資料の整理"] },
  { line: "中2 数学", topics: ["式の計算（多項式）", "連立方程式", "一次関数", "平行と合同", "三角形と四角形", "確率"] },
  { line: "中3 数学", topics: ["式の展開", "因数分解", "平方根", "二次方程式", "二次関数 y=ax^2", "相似", "円の性質", "三平方の定理", "標本調査"] },
  { line: "高校 数I", topics: ["数と式（実数・絶対値）", "一次不等式", "集合と命題", "二次関数（一般形・最大最小）", "二次方程式と判別式", "三角比", "図形と計量（正弦・余弦定理）", "データの分析"] },
  { line: "高校 数A", topics: ["場合の数", "順列と組合せ", "確率", "整数の性質", "図形の性質"] },
];
